...
namespace xd
{
	...
	public:
		texture_shader();
		virtual void setup(const glm::mat4& mvp, const texture::handle tex);
	};
	...
	public:
		texture_mask_shader();
		virtual void setup(const glm::mat4& mvp, const texture::handle tex, const texture::handle mask);
	};
